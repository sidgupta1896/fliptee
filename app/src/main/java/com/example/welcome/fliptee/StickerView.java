...
public abstract class StickerView extends FrameLayout{
    ...
    private void init(Context context){
        ...
        this.iv_hide = new ImageView(context);
        ...
        this.iv_flip.setImageResource(R.drawable.correct_hide);
        ...
        FrameLayout.LayoutParams iv_hide_params =
                new FrameLayout.LayoutParams(
                        convertDpToPixel(BUTTON_SIZE_DP, getContext()),
                        convertDpToPixel(BUTTON_SIZE_DP, getContext())
                );
        iv_hide_params.gravity = Gravity.TOP | Gravity.LEFT;
        ...
        this.addView(iv_hide, iv_hide_params);
        ...
        this.iv_hide.setOnClickListener(new OnClickListener() {
            @Override
